...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { course_id: @score.course_id, score: @score.score, student_id: @score.student_id }
    end
  ...
  test "should update score" do
    patch :update, id: @score, score: { course_id: @score.course_id, score: @score.score, student_id: @score.student_id }
    assert_redirected_to score_path(assigns(:score))
  end
